...
<head>
    ...
    <link rel="icon" href="${Path}/static/bookIco.png">
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="#" class="logo" style="font-size: 18px">儿童书店管理系统</a>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            ...
            <c:if test="${user.userType == 0}"><p><span class="userName">${user.userName}</span>，欢迎登陆</p></c:if>
            <c:if test="${user.userType == 1}"><p><span class="userName">店长，${user.userName}</span>，欢迎登陆</p></c:if>
            <c:if test="${user.userType == 2}"><p><span class="userName">店员，${user.userName}</span>，欢迎登陆</p></c:if>
        </div>
