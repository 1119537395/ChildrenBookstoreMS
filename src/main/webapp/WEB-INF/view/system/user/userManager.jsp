...
<div style="display: none" id="addAndEditModel">
    ...
    <form class="layui-form layui-form-pane" action="" lay-filter="addUserFrame" id="addUserFrame" style="margin: 20px">
        ...
        <div class="layui-form-item" id="userNumber">
            <label class="layui-form-label">工号</label>
            <div class="layui-input-block">
                <input type="text" name="userNumber" autocomplete="off" class="layui-input" placeholder="请输入用户工号">
            </div>
        </div>
...
<div style="display: none" id="changePasswordModel">
    ...
    <form class="layui-form layui-form-pane" action="" lay-filter="changePassword" id="changePassword" style="margin: 20px">

        <div class="layui-form-item" >
            <label class="layui-form-label">账户名</label>
            <div class="layui-input-block">
                <input type="text" name="userAccount" id="userAccount" autocomplete="off" readonly="readonly" lay-verify="required" class="layui-input" placeholder="请输入修改的密码">
            </div>
        </div>
    ...
    layui.use(['table', 'layer', 'form', 'jquery', 'laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[
                ...
                , {field: 'userNumber', title: '工号',width: 160, align: "center"}
                , {
                ...
                , {field: 'userPhone', title: '手机号码',width: 160, align: "center"}
        ...
        function resetUserPassword(userData) {
            maxIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    $("#userAccount").val(userData.userAccount);
                }
            });
        }
